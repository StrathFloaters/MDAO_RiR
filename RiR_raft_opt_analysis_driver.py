...
match input_option:
    ...
    case "1A":
        fname_wt_input = os.path.join(run_dir, "..", "inp1_modA_anatowr", "outputs", "inp1_modA_anatowr.yaml")
    case "1B":
        fname_wt_input = os.path.join(run_dir, "..", "inp1_modB_anatowr", "outputs", "inp1_modB_anatowr.yaml")
    case "1C":
        fname_wt_input = os.path.join(run_dir, "..", "inp1_modC_anatowr", "outputs", "inp1_modC_anatowr.yaml")
    case _:
